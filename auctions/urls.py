...
urlpatterns = [
    ...
    path("listing-page/<int:auction_id>", views.listing_page, name="listing_page"),
    ...
    path("active-listing/<str:category>", views.active_listing, name="active_listing"),
    path("my-listings/<str:lister>", views.my_listings, name="my_listings"),
